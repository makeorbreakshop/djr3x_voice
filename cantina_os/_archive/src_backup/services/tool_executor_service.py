...
from src.event_payloads import (
...
class ToolExecutorService(BaseService):
    ...
    async def _start(self) -> None:
        ...
        await self._emit_status("RUNNING", "Tool executor service started")
        
    async def _stop(self) -> None:
        """Stop the service and clean up resources."""
        self.registered_tools.clear()
        await self._emit_status("STOPPING", "Tool executor service stopping")
        await super()._stop()
    ...
    async def _handle_tool_registration(self, payload: ToolRegistrationPayload) -> None:
        ...
        try:
            ...
            if not callable(tool_func):
                ...
                await self._emit_status("ERROR", f"Failed to register tool: {error_msg}")
                return
