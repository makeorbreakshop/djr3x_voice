...
# Import the service
from cantina_os.services.music_source_manager_service.music_source_manager_service import MusicSourceManagerService
...
async def test_spotify_config():
    ...
    music_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "audio", "music")
