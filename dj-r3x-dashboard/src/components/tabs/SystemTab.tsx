    ...
    <div className="space-y-6">
            ...
            <tbody>
              {services.map((service, index) => (
                <tr key={index} className="border-b border-sw-blue-600/10 hover:bg-sw-dark-700/20">
                  <td className="py-3 text-sm text-sw-blue-100 font-mono">{service.name}</td>
                  <td className="py-3">
                    <div className="flex items-center space-x-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 sw-panel">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                {services.map((service) => (
                  <option key={service.name} value={service.name}>{service.name.replace('Service', '')}</option>
                ))}
              </select>
              <select
                value={logLevel}
          ...
          <div className="bg-sw-dark-700/50 rounded-lg border border-sw-blue-600/20 p-4 h-80 overflow-y-auto font-mono text-sm">
